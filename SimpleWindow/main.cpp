...
int main(int argc, char *argv[])
{
    ...
    else if (FileExists("../SimpleWindow/window.state"))
    {
        std::cout << "State file found in SimpleWindow folder." << std::endl;
        configPath = "../SimpleWindow/window.state";
    }
    else
    {
    ...
    InitWindow(screenWidth, screenHeight, "HelloWorld - Raylib");
    ...
    while (!WindowShouldClose())
    {
        ...
        DrawText("Hello, World! Raylib is up and running.", 190, 200, 20, LIGHTGRAY);
